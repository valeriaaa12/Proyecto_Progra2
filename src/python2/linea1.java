 ...
 */
public class linea1 extends Figura implements Serializable{

    public linea1() {
    }

    public linea1(Color color, int x, int y) {
        super(color, x, y);
    }
    ...
    public void crearLinea1(int Num, JLabel x) {
        ...
        x.setIcon(new ImageIcon(".\\build\\classes\\linea1.png"));
